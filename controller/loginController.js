...
exports.autenticarJWT = exports.loginAutenticar = exports.validarEmail = exports.hashearTexto = void 0;
var JWT = require("jsonwebtoken");
var dotenv = require("dotenv");
var funcionarioController = require("./funcionarioController");
var Bcrypt = require("bcrypt");
function hashearTexto(texto) {
    if (typeof texto == "undefined")
        return;
    return Bcrypt.hashSync(texto, 10);
}
exports.hashearTexto = hashearTexto;
...
function loginAutenticar(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var senha, email, funcionario;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    senha = req.body.Senha;
                    email = req.body.Email;
                    return [4 /*yield*/, funcionarioController.buscaFuncionarioPorEmail(email)];
                case 1:
                    funcionario = _a.sent();
