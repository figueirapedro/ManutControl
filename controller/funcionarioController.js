...
function listarFuncionario(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, funcionario_1.Model.find({})];
                case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, funcionario_1.Model.findByIdAndDelete(req.params.id)];
                case 1:
                    funcionarios = _a.sent();
                    if (!funcionarios)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, funcionario_1.Model.find({ Email: email })];
                case 1:
                    funcionario = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (cpf == undefined)
                        return [2 /*return*/, false];
                    return [4 /*yield*/, funcionario_1.Model.find({ CPF: cpf })];
                case 1:
                    funcionario = _a.sent();
                    return [2 /*return*/, funcionario[0] == undefined ? false : funcionario[0]];
            }
