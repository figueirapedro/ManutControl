...
function listarManutencao(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, manutencao_1.Model.find({})];
                case 1:
                    manutencao = _a.sent();
                    try {
                        res.send(manutencao);
...
function alterarManutencao(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var manutencao, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, manutencao_1.Model.findOneAndUpdate({ Id: req.params.id }, req.body)];
                case 1:
                    manutencao = _a.sent();
                    return [4 /*yield*/, manutencao.save()];
                case 2:
...
function removerManutencao(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var manutencao, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, manutencao_1.Model.findOneAndDelete({ Id: req.params.id })];
                case 1:
                    manutencao = _a.sent();
                    if (!manutencao)
