...
var setor_1 = require("../model/setor");
// CRUD para Setor
function inserirSetor(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setor = new setor_1.Model(req.body);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, setor.save()];
                case 2:
                    _a.sent();
                    res.send(setor);
                    return [3 /*break*/, 4];
...
function listarSetor(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setor_1.Model.find({})];
                case 1:
                    setor = _a.sent();
                    try {
                        res.send(setor);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, setor_1.Model.findOneAndUpdate({ Id: req.params.id }, req.body)];
                case 1:
                    setor = _a.sent();
                    return [4 /*yield*/, setor.save()];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, setor_1.Model.findOneAndDelete({ Id: req.params.id })];
                case 1:
                    setor = _a.sent();
                    if (!setor)
