...
function inserirEquipamento(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var equipamentos, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    equipamentos = new equipamento_1.Model(req.body);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, equipamentos.save()];
                case 2:
                    _a.sent();
...
function listarEquipamento(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, equipamento_1.Model.find({})];
                case 1:
                    equipamentos = _a.sent();
                    try {
                        res.send(equipamentos);
                    }
                    catch (error) {
...
function alterarEquipamento(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var equipamentos, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, equipamento_1.Model.findOneAndUpdate({ Id: req.params.id }, req.body)];
                case 1:
                    equipamentos = _a.sent();
                    return [4 /*yield*/, equipamentos.save()];
                case 2:
...
function removerEquipamento(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var equipamentos, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, equipamento_1.Model.findOneAndDelete({ Id: req.params.id })];
                case 1:
                    equipamentos = _a.sent();
                    if (!equipamentos)
